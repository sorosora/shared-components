...
var ExpandableWrapper = styled.div.withConfig({
  ...
  return theme.media.tablet(css(["max-height:", ";"], function (_ref4) {
  ...
  return theme.media.phone(css(["max-height:", ";"], function (_ref6) {
...
var ClickableWrapper = styled.div.withConfig({
...
var RatioWrapper = styled.div.withConfig({
  ...
  return theme.media.tablet(css(["padding-bottom:", ";height:", ";;", "{position:", ";;}"], function (_ref3) {
  ...
  return theme.media.phone(css(["padding-bottom:", ";height:", ";;", "{position:", ";;}"], function (_ref7) {
