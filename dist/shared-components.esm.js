...
var typeList = {
  cover: css(["width:100%;height:100%;object-fit:cover;font-family:", ";"], function (_ref) {
    var ie = _ref.ie;
    return ie ? 'object-fit: cover;' : '';
  }),
  contain: css(["width:100%;height:100%;object-fit:contain;font-family:", ";"], function (_ref2) {
    var ie = _ref2.ie;
...
var NormalImg = styled.img.withConfig({
...
var Source = styled.source.attrs(function (_ref4) {
...
var withPrefetch = function withPrefetch(ComposedComponent) {
  var urls = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  var WithPrefetch = function WithPrefetch(props) {
    var children = props.children;
    return React.createElement(ComposedComponent, props, children, urls.map(function (url, key) {
  ...
  return styled(WithPrefetch).withConfig({
...
var amphtmlContext = createCommonjsModule(function (module, exports) {
...
exports.AmpModeContext = React$$1.createContext({});
});

unwrapExports(amphtmlContext);
var amphtmlContext_1 = amphtmlContext.AmpModeContext;
...
Object.defineProperty(exports, "__esModule", { value: true });
const React$$1 = __importStar(React);
exports.HeadManagerContext = React$$1.createContext(null);
});

unwrapExports(headManagerContext);
var headManagerContext_1 = headManagerContext.HeadManagerContext;

var amp = createCommonjsModule(function (module, exports) {
...
exports.isAmp = isAmp;
function useAmp() {
    const ampMode = react_1.default.useContext(amphtmlContext.AmpModeContext);
...
unwrapExports(amp);
var amp_1 = amp.isAmp;
var amp_2 = amp.useAmp;
var amp_3 = amp.withAmp;
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_1 = __importDefault(React);
const side_effect_1 = __importDefault(sideEffect);
...
function Head({ children }) {
    return (react_1.default.createElement(amphtmlContext.AmpModeContext.Consumer, null, (ampMode) => (react_1.default.createElement(headManagerContext.HeadManagerContext.Consumer, null, (updateHead) => (react_1.default.createElement(Effect, { reduceComponentsToState: reduceComponents, handleStateChange: updateHead, isAmp: amp.isAmp(ampMode) }, children))))));
}
...
var withPreload = function withPreload(Component, urls) {
  var as = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'image';
  var type = arguments.length > 3 ? arguments[3] : undefined;
  return function (props) {
    return React.createElement(React.Fragment, null, React.createElement(head$3, null, urls.map(function (url, key) {
      return React.createElement("link", _extends({
        rel: "preload",
        href: url,
        as: as,
        key: "".concat(url + key)
      }, _defineProperty({}, type ? 'type' : undefined, type)));
    })), React.createElement(Component, props));
  };
};

export { Collapse, ConditionalWrap, InlineCenter, Img, RatioBox, withPrefetch, withPreload };
